        ...
        <form action="/savebien" method="Post">
            ...
            <div class="grid grid-cols-6 gap-6">
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <input type="text" name="nombien" id="product-name"
                ...
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <input type="text" name="adresse" id="price"
                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"
                ...
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <input type="date" name="datepub" id="price"
                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"
                        placeholder="$2300" required="">
                </div>
                <div class="col-span-full">
                    ...
                    <textarea id="product-details" rows="6"
                        ...
                        placeholder="Details" name="description"></textarea>
                </div>
            </div>
